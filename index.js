...
audio20 = fs.readFileSync('./Z3/Ramdani20.m4a') 
            ...
            const nnnyz5 = [
            {buttonId: 'id1', buttonText: {displayText: 'selamat datang'}, type: 1}]
            const nnnyz6 = {contentText: `Haloo @${memJid.split('@')[0]}\n\nSelamat datang di grup ${mdata.subject}\n\nkamu bisa langsung berkomunikasi denganku dengan cara ketik #menu\n\nSelamat bersenang senang dan semoga betah `, footerText: `© created ${nama}`, buttons: nnnyz5, headerType: 6, locationMessage: nnnyz4.message.locationMessage}
            ...
            let nnnyz4 = nnnyz3.message["ephemeralMessage"] ? nnnyz3.message.ephemeralMessage : nnnyz3
            const nnnyz5 = [
            {buttonId: 'id1', buttonText: {displayText: 'papai'}, type: 1}]
            const nnnyz6 = {contentText: `*yahh @${memJid.split('@')[0]} telah memutuskan untuk left dari gc ${mdata.subject} semoga ia tenang di sana`, footerText: `© created ${nama}`, buttons: nnnyz5, headerType: 6, locationMessage: nnnyz4.message.locationMessage}
            nayla.sendMessage(mdata.id,  nnnyz6, MessageType.buttonsMessage,{caption: 'whatsapp',"contextInfo": {text: 'SYLBOT', "forwardingScore": 1000000000, isForwarded: true, sendEphemeral: true, "mentionedJid" : [memJid], },sendEphemeral: true})             
            }
		    } catch (e) {
			console.log(e)
...
menu4 = "BOT VERSI 1 : https://youtube.com/channel/UCB157jomCne961WzYHpG4gg"  
		    ...
		    reply(` *403 NOT FOUND*\n\nMaaf fitur ${command} sepertinya tidak terdaftar di dalam menu bot, silahkan cek menu kembali`)
		    }
